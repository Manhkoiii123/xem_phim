...
//slide tự động chạy và thay đổi chữ ở trong 
const slider_load = ()=>{
    setTimeout(() => {
...
setInterval(slider_load,6000);//chạy lại từ đầu
slider_load();
...
videos.addEventListener('timeupdate', () => {
    ...
    //nếu phút < 10 thì thêm số 0 ở đầu
    if (start_min < 10) {
    ...
    //cập nhật thời gian chạy trên thanh seek
    ...
    // end 
    //thời gian hết thì chạy lùi lại
    ...
    let seek_2 = document.getElementById('seek_2');//tiến trình chạy 
    ...
    let sec_30 = document.getElementById('sec_30');//lùi lại 10
    seek.addEventListener('change', () => {
            videos.currentTime = seek.value * videos.duration / 100;
            sec_30.addEventListener('click', () => {
                videos.currentTime = seek.value * ((videos.duration - 10) / 100);
            });
        })
        // video end event 
...
let adven1 = document.getElementById('adven1');
let adven_bx = document.getElementById('adven_bx');

adven1.addEventListener('click', () => {
    adven1.classList.toggle('cato_button_active');
    adven_bx.classList.toggle('movie_box_active');
});

const adven_array = movies.filter((e) => {
    return e.genre3 == "adeventure";
});

adven_array.forEach(element => {
    const { img, title, year, url, rate } = element;
    let card = document.createElement('div');
    card.classList.add('card');
    card.innerHTML = `
    ...
    adven_bx.appendChild(card);
});

let bio1 = document.getElementById('bio1');
let bio_bx = document.getElementById('bio_bx');

bio1.addEventListener('click', () => {
    bio1.classList.toggle('cato_button_active');
    bio_bx.classList.toggle('movie_box_active');
});

const bio_array = movies.filter((e) => {
    return e.genre4 == "biography";
});

bio_array.forEach(element => {
    const { img, title, year, url, rate } = element;
    let card = document.createElement('div');
    card.classList.add('card');
    card.innerHTML = `
    ...
    bio_bx.appendChild(card);
});

let ani1 = document.getElementById('ani1');
let ani_bx = document.getElementById('ani_bx');

ani1.addEventListener('click', () => {
    ani1.classList.toggle('cato_button_active');
    ani_bx.classList.toggle('movie_box_active');
});

const ani_array = movies.filter((e) => {
    return e.genre5 == "animation";
});

ani_array.forEach(element => {
    const { img, title, year, url, rate } = element;
    let card = document.createElement('div');
    card.classList.add('card');
    card.innerHTML = `
    ...
    ani_bx.appendChild(card);
});


let com1 = document.getElementById('com1');
let com_bx = document.getElementById('com_bx');

com1.addEventListener('click', () => {
    com1.classList.toggle('cato_button_active');
    com_bx.classList.toggle('movie_box_active');
});

const com_array = movies.filter((e) => {
    return e.genre6 == "comady";
});

com_array.forEach(element => {
    const { img, title, year, url, rate } = element;
    let card = document.createElement('div');
    card.classList.add('card');
    card.innerHTML = `
    ...
    com_bx.appendChild(card);
});

let doc1 = document.getElementById('doc1');
let doc_bx = document.getElementById('doc_bx');

doc1.addEventListener('click', () => {
    doc1.classList.toggle('cato_button_active');
    doc_bx.classList.toggle('movie_box_active');
});

const doc_array = movies.filter((e) => {
    return e.genre7 == "documentary";
});

doc_array.forEach(element => {
    const { img, title, year, url, rate } = element;
    let card = document.createElement('div');
    card.classList.add('card');
    card.innerHTML = `
